...
const COPY: Record<Lang, Copy> = {
  en: {
    ...
    industries: {
      hehku: 'Skincare & Beauty', bubbly: 'Food & Beverage', magic: 'Fashion & Apparel', throne: 'Streetwear', luxe: 'Luxury Fragrance',
      lensrappa: 'Eyewear', amour: 'Bags & Luggage', radiance: 'Jewelry & Accessories', phenomena: 'Cosmetics & Makeup', noblesse: 'Coffee & Homeware',
    },
    niches: {
      hehku: 'Nordic skincare brand with fresh, fruit-based formulas',
      bubbly: 'sparkling drinks brand with bold Nordic flavors',
      magic: 'contemporary fashion boutique with an editorial look',
      throne: 'streetwear brand built for large, fast-moving catalogs',
      ...
      noblesse: 'premium coffee and homeware brand',
    },
  ...
  fr: {
    ...
    formatPublished: (d, m, y) => `${d} ${m} ${y}`,
    industries: {
      hehku: 'Soins & Beauté', bubbly: 'Boissons & Alimentation', magic: 'Mode & Habillement', throne: 'Streetwear', luxe: 'Parfumerie de luxe',
      lensrappa: 'Lunetterie', amour: 'Maroquinerie & Bagages', radiance: 'Bijoux & Accessoires', phenomena: 'Cosmétiques & Maquillage', noblesse: 'Café & Maison',
    },
    niches: {
      hehku: 'marque de soins nordique aux formules fraîches et fruitées',
      bubbly: 'marque de boissons pétillantes aux saveurs nordiques',
      magic: 'boutique de mode contemporaine au look éditorial',
      throne: 'marque de streetwear pensée pour de grands catalogues',
      ...
      noblesse: "marque premium de café et d'articles pour la maison",
    },
    descTpl: (name, niche, theme) =>
  ...
  es: {
    ...
    industries: {
      hehku: 'Cuidado de la piel y belleza', bubbly: 'Alimentación y bebidas', magic: 'Moda', throne: 'Streetwear', luxe: 'Perfumería de lujo',
      lensrappa: 'Gafas', amour: 'Bolsos y equipaje', radiance: 'Joyería y accesorios', phenomena: 'Cosméticos y maquillaje', noblesse: 'Café y hogar',
    },
    niches: {
      hehku: 'marca nórdica de cuidado de la piel con fórmulas frescas y afrutadas',
      bubbly: 'marca de bebidas con gas de sabores nórdicos',
      magic: 'boutique de moda contemporánea con estética editorial',
      throne: 'marca de streetwear pensada para catálogos grandes',
      ...
      noblesse: 'marca premium de café y artículos para el hogar',
    },
    descTpl: (name, niche, theme) =>
  ...
  it: {
    ...
    formatPublished: (d, m, y) => `${d} ${m} ${y}`,
    industries: {
      hehku: 'Skincare e bellezza', bubbly: 'Cibo e bevande', magic: 'Moda', throne: 'Streetwear', luxe: 'Profumeria di lusso',
      lensrappa: 'Occhialeria', amour: 'Borse e valigie', radiance: 'Gioielli e accessori', phenomena: 'Cosmetici e make-up', noblesse: 'Caffè e casa',
    },
    niches: {
      hehku: 'marchio nordico di skincare con formule fresche e fruttate',
      bubbly: 'marchio di bevande frizzanti dai sapori nordici',
      magic: 'marchio di moda contemporanea dal look editoriale',
      throne: 'marchio streetwear pensato per grandi cataloghi',
      ...
      noblesse: 'marchio premium di caffè e articoli per la casa',
    },
    descTpl: (name, niche, theme) =>
  ...
  de: {
    ...
    formatPublished: (d, m, y) => `${d}. ${m} ${y}`,
    industries: {
      hehku: 'Hautpflege & Beauty', bubbly: 'Essen & Getränke', magic: 'Mode & Bekleidung', throne: 'Streetwear', luxe: 'Luxusparfüm',
      lensrappa: 'Brillen', amour: 'Taschen & Gepäck', radiance: 'Schmuck & Accessoires', phenomena: 'Kosmetik & Make-up', noblesse: 'Kaffee & Homeware',
    },
    niches: {
      hehku: 'nordische Hautpflegemarke mit frischen, fruchtigen Formeln',
      bubbly: 'Getränkemarke mit prickelnden nordischen Sorten',
      magic: 'moderne Modeboutique mit editorialem Look',
      throne: 'Streetwear-Marke für große Kataloge',
      ...
      noblesse: 'Premium-Marke für Kaffee und Homeware',
    },
    descTpl: (name, niche, theme) =>
